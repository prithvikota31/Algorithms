...
| 15 | ☑ | Interval progression: determine whether two intervals overlap; follow-ups: whether any pair overlaps, count overlaps, assign meetings to the minimum rooms, insert an interval, and merge overlaps. → [overlap](15-interval-overlap/IntervalOverlap.java), [any-pair](15-interval-overlap/AnyPairOverlap.java), [max-simultaneous](15-interval-overlap/MaxSimultaneousOverlap.java), [meeting-rooms](15-interval-overlap/MeetingRoomAssignment.java), [insert](15-interval-overlap/InsertInterval.java), [merge](15-interval-overlap/MergeIntervals.java) |
