...
| 6 | ☐ | Multiple people travel to one destination and may share parts of their routes; minimize total cost or number of distinct edges used. _(base done: 2-person unweighted, 3×BFS meeting-node; multi-source follow-up (reported) + weighted/total-cost follow-up (inferred) pending)_ → [solution](6-shared-route-meeting-point/SharedRouteMeetingPoint.java) |
