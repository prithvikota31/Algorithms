...
| 6 | ☑ | Multiple people travel to one destination and may share parts of their routes; minimize total cost or number of distinct edges used. _(2-person unweighted, 3×BFS meeting-node. Multi-source intentionally NOT coded — general case is a Steiner Tree (NP-hard); only special structure is tractable, noted in file. Weighted/total-cost follow-up (3× Dijkstra ≈ LC 2203) noted as optional)_ → [solution](6-shared-route-meeting-point/SharedRouteMeetingPoint.java) |
